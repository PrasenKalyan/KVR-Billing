...
<title>JTECHNO ASSOCIATES</title>
<style>
    .first-half {
    float: left;
    width: 50%;
...
<div class="noBorder"  ><th   colspan="14"style="border-right:none !important;font-size:18px;">
			<img style="margin-left:280px;" src="images/best.png" height="100"/></div>
...
<td colspan="2">
    <b>State: </b><?php  if($state1==$state) echo $state;?>
</td>
</tr>
<tr><td colspan="2"> 
...
echo  "<script type=\"text/javascript\"> 
   ...
   setTimeout(\"DoTheRedirect('bill_list31.php?state=$state')\",parseInt(2*1000));

...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	document.getElementById("serv_amt"+id).value=strar[6];
		document.getElementById("remarks"+id).value=strar[7];
	
	
    }
  }
xmlhttp.open("GET","get_oditems.php?q="+str,true);
xmlhttp.send();
}
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">OD Quotations</a>
                            </li>
                            <li>
                                <a href="odqot_list.php"> OD Quotations List</a>
                            </li>
                            <li>
                                <a href="">Edit OD Quotations</a>
                            </li>
                 ...
                 <?php  $id=$_GET['id'];
						$sq=mysqli_query($link,"select * from add_odqot where id='$id'");
...
<div class="row">
 ...
 <form name="frm" method="post" action="odqot_suc.php" enctype="multipart/form-data">
...
$sql="select distinct store_code from dpr where state='OD' ";  // Query to collect records
...
<button type="button" class='btn btn-danger delete'>-</button>
  ...
  <tr><td colspan="3"><a onclick="window.open('addoduitems.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" >Add Items</a></td>
											...
											<?php 
											 ...
											 $aa="select * from add_odqot1 where id1='$id1'";
												...
												<?php if($rono!=' '){ ?>
													<a onclick="return confirm('Are you sure you want to delete this item?');" href='delete_odline.php?id=<?php echo $rs1['id']; ?>&id1=<?php echo $rs1['id1'];?>'><input type="button" class="btn btn-danger" value="Delete"></button></a>
 ...
 <td>
							<input type="text" name="remarks[]" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?> value="<?php echo $rs1['remarks']; ?>" style="width:60px;" data-row="<?php echo $i?>" class=""  /> 
														</td>
									...
									<td><input style="width:60px;" type="text" readonly placeholder="Total Serv" name="tot_serv" class="txt5" value="<?php echo $r['tot_ser'];?>" id="tot_serv" />+
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="odqot_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">
...
data +="<td><input type='text' name='amnt[]' data-row='"+i+"' value='' style='width:60px;' readonly class='txt tx6' id='amnt"+i+"' /> </td>";          
   ...
   data +="<td><input type='text' name='gst_amnt[]' data-row='"+i+"' value='' style='width:60px;' class='txt4 ' readonly  id='gst_amnt"+i+"' /> </td>";          
   	...
   	data +="<td><input type='text' name='remarks[]'  id='remarks"+i+"' value='' style='width:70px;' data-row='"+i+"'></td>";
	data +="</tr>";

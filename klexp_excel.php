...
//	if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='vishnu')){
     $y="SELECT * FROM expenses where state='KL' ORDER BY id desc";    
    //}else{
...
$sqy=mysqli_query($link,"SELECT * FROM expenses where state='KL' ORDER BY id desc");  
...
header('Content-Disposition: attachment;filename="klexpenses.xlsx"'); //tell browser what's the file name

...
<table border='1' style="width:90%" align="center"  cellpadding="0" cellspacing='0'>
        <thead>
			...
			<img style="margin-left: 70px; margin-bottom: 5px;" src="images/best.png" height="100"/></th></tr>
        </thead>
        <tfoot>
...
<?php $sqy=mysqli_query($link,"select * from organization where id='1'");
			...
			$tg_address=$r2y['tg_address'];
			$tg_gst=$r2y['tg_gst'];
			$vendor_code1=$r2y['vendor_code1'];
			?>
...
echo  "<script type=\"text/javascript\"> 
   ...
   setTimeout(\"DoTheRedirect('tgwtsqot_list.php?state=$state')\",parseInt(2*1000));

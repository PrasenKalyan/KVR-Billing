            ...
            <div class="main-content">
                <div class="main-content-inner">
                  ...
                  <?php  $id=$_GET['id'];
						...
						$y=mysqli_query($link,"select * from klrequest_amnt where quet_num='$qtno' order by id desc limit 1");
...
<div class="row">
 ...
 <form name="frm" method="post" action="klwtsqot_suc.php" enctype="multipart/form-data">
						...
						<input type="hidden" name="serv_code[]" value="<?php echo $rs1['serv_cap']; ?>" style="width:50px;" class="" id="serv_code<?php echo $i?>" />	   
									...
									<td><input style="width:60px;" type="text" readonly placeholder="Total Serv" name="tot_serv" class="txt5" value="<?php echo $r['tot_ser'];?>" id="tot_serv" />+
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="klwtsqot_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">

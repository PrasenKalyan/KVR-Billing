 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
                                            <table class="table table-striped table-bordered table-hover">
											  ...
											  <input  type="text" readonly  class="form-control" required value="<?php echo $id?>"  name="qt_no" id="qt_no"></td>
										...
										id="inv_no"  class="form-control" required value="<?php echo $r1['inv_num'];?>" onkeyup="checkAvailability()">
										...
										<input type="text" name="speriod" required id="speriod" class="form-control" /></td>	
                                        <td align="right">Format Type</td><td>
										<input id="ftype1" type="text" required class="form-control" name="ftype" onkeyup='s3(1)' >

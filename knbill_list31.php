                                   ...
                                   <div style="overflow-x:auto;">     
											...
											while($rs1=mysqli_fetch_array($t)){
                                                   ...
                                                   <th><?php echo $rs1['user']; ?></th>
													...
													<td class="hidden-480"><a href="knqotti_pdf.php?id=<?php echo $rs1['quet_num']; ?>">
                                                         <img src="images/pdf_icon.gif" width="30" height="30"></a></td>
													<td class="hidden-480"><a href="knqotbrk_excel.php?id=<?php echo $rs1['quet_num']; ?>">
                                                          <img src="images/xl.jpg" width="20" height="20"></a></td>
													   <td class="hidden-480"><a href="knqotbrk_pdf.php?id=<?php echo $rs1['quet_num']; ?>">
                                                         <img src="images/pdf_icon.gif" width="30" height="30"></a></td>

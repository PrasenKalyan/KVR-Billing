...
elseif($state=='TG'){
  $qottable ='add_tgqot';
  $addbill1 ='add_tgbill1'; 
  $billtable='tgqot_bill';
}
 elseif($state=='TN'){
  $qottable ='add_tngqot';
  $addbill1 ='add_tnbill1'; 
  $billtable='tnqot_bill';
}
elseif($state=='KL'){
  $qottable ='add_klqot';
  $addbill1 ='add_klbill1'; 
  $billtable='klqot_bill';
}
else if($state=='KN'){
  $qottable ='add_knqot';
  $addbill1 ='add_knbill1'; 
  $billtable='knqot_bill';
}
elseif($state=='OD'){
  $qottable ='add_odqot';
  $addbill1 ='add_odbill1'; 
...
$q=mysqli_query($link,"select * from ".$qottable." where id='$bid'") or die(mysqli_error($link));
...
?>
   ...
   <!-- style="width:100%;height:120px;"-->
    ...
    <table border='1'  cellpadding="0" cellspacing='0'>
        <thead>
            <tr class="noBorder" ><th   colspan="9" style="padding-top:20px;border-right:none !important;font-size:18px;">KVR BEST</th></tr>
 <tr><td colspan="9">      
<hr></td></tr>
	   </thead>
        <tfoot>
        ...
        <tr><td colspan="8" style="text-align:center;font-size:18px;border:0px;"><b><?php echo $state;?> QUOTATIONS LIST</b></td></td></tr>
...
$bid=$r['id'];
	 ...
	 $aa="select * from ".$qottable." where status='Ro Required' order by id desc";
...
<?php $i++;}?>
    ...
    <!-- <tr>
        ...
        <th colspan="6" style="font-size:14px;  border-right-color: #000 !important; border-bottom-color: #000 !important;">ForJTECHNO,
        <br/><br/>
	   <br/>  <br/>  <br/>

...
<td colspan="1"><b >State: </b><?php if($state1=='OD') echo 'Odisha';?></td>
</tr>
<tr>
...
<td colspan="2">
    <b>State: </b><?php  if($state1=='OD') echo 'Odisha';?>
</td>
</tr>
<tr><td colspan="2"> 
    <b>State Code: </b>21
...
echo  "<script type=\"text/javascript\"> 
   ...
   setTimeout(\"DoTheRedirect('odbill_list31.php')\",parseInt(2*1000));

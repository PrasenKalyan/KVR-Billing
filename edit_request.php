                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">AP Request Amount Approve  </a>
                            </li> -->
                            <li>
                                <a href="qot_list.php"> AP Request Amount Approve </a>
                            </li>
                            <li>
...
<div class="row">
 ...
 <input type="hidden" name="ids<?php echo $i; ?>" value="<?php echo $id1?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
                                       ...
                                       <td align="right">Image 1</td><td><img src="upload/<?php echo $r1['img1'];?>" onclick="window.open('qut_image.php?id=<?php echo $r1['img1'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                      </td>  </tr>
							...
							echo $dd="update request_amnt set confirm='$confirm',approve_amnt='$approve_amnt1',remarks='$remarks' where id='$id'";
	...
	if(isset($_POST['update2'])){
							...
							echo $dd="update request_amnt set confirm='$confirm',approve_amnt='$approve_amnt2',remarks='$remarks' where id='$id2'";
							$ssq=mysqli_query($link,$dd);
			...
			print "</script>";
							...
							echo $dd="update request_amnt set confirm='$confirm',approve_amnt='$approve_amnt3',remarks='$remarks' where id='$id3'";
							$ssq=mysqli_query($link,$dd);

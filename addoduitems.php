...
if(str=="No"){
    document.getElementById('s_fee').value='6'
}
}
</script>
	<script>
...
<div class="row">
 ...
 <form name="frm" method="post" id="register-form" action="oduitems_suc.php">
										...
										<select name="cap" required class="form-control" onchange="showHint22(this.value)">
									...
									<option value="No">No</option>
										...
										<input type="text"  class="form-control" name="s_fee" id="s_fee">
                                        ...
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="oduploaditems_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">

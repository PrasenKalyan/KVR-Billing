...
xmlhttp.open("GET","getfilterinforpages.php?q="+str+"&statetable=add_odqot",true);
xmlhttp.send();
}
...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_odqot.php'" id="bsearch">   Add New  </button>
		-->
</div>
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
				  ...
				  <div class="col-sm-2"><b><a href="qut_odwts_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
				    <div class="col-sm-1"><b>
					 <a onclick="window.open('qut_od_print.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"
...
<datalist id="city27" >
   ...
   <th>   <input type="reset" value="Reset" name="submit1" class="btn btn-danger"  onclick="javascript:location.href='odqot_list.php'"> </th>
   <th>    </th>
<!--
...
style="width:16px; font-size:8px; height:16px; background-image:url(images/FilterNone.gif); background-repeat:no-repeat;
 margin-top:5px;" onclick="javascript:location.href='qot_list1.php'">--> </th> <th></th><th></th>
										...
										// $y="select * from add_odqot where quet_num like '%$bsearch%' or falt_no like '%$bsearch%'  or status like '%$bsearch%'order by id desc";
										$y="select * from add_odqot where (quet_num like '%$bsearch%' or falt_no like '%$bsearch%')  and  status='work to be started' order by id desc";
												} else
												...
												$city=$_POST['city'];	
												$status=$_POST['status'];
												/*echo $y="select  a.quet_num,a.store_code,a.inv_date,a.status,a.id from add_odqot a,dpr b where a.quet_num='$qot_nun'
											...
											$y="select  a.quet_num,a.store_code,a.inv_date,a.status,a.id from add_odqot a,dpr b where
...
$r1=mysqli_fetch_array($ssq1);
                                                   ...
                                                   <a onclick="window.open('odqut_print.php?id=<?php echo $rs1['id'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"
												   class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
                                                        </td> 
                                                        
                                                         <td class="hidden-480">
                                                       <a href="odqot_pdf.php?id=<?php echo $rs1['id'];?>"
...
echo "<li><a href='odwtsqot_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='odwtsqot_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

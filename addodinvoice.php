                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="odbill_list2.php"> To be raised Invoice</a>
                            </li>
                            <!-- <li>
                                <a href="">To be raised Invoice</a>
                            </li> -->
...
<div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <?php //$ssq=mysqli_query($link,"select * fromodlqot_bill where quet_num='$id'");
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
                                        ...
                                        <td align="right">Bill Received Date</td><td><input type="date" value="<?php echo $r1['bill_date'];?>"   name="bill_date" id="inv_date" class="form-control"></td>
                                        </tr>
					...
					<tr><td align="right">28 % Gst</td><td align="left">
									...
									<input type="hidden" name="id1" 
										...
										if(isset($_POST['update'])){
											...
											$state=$_POST['state'];
											$note=$_POST['note'];
											$speriod=addslashes($_POST['speriod']);
											$ftype=addslashes($_POST['ftype']);
											$tbase=$_POST['tbase'];
											$gst28=$_POST['gst28'];
											$gst18=$_POST['gst18'];
											$gst12=$_POST['gst12'];
	...
	$iname5 = ($iname5);
	 ...
	 $iname5 = ($img3);
												...
												$sq1="insert into odqot_bill(bill_date,inv_num,inv_date,note1,inv_sub_date,status,speriod,ftype,tbase,gst28,gst18,gst12,gst5,gst0,user,file)
			...
			print "self.location='odbill_list2.php';";
			print "</script>";
											}
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="odbill_list2.php"><button class="btn btn-danger" type="button" name="button" id="Close">

...
$s_code=$_POST['s_code'];	
	...
	$sq=mysqli_query($link,"INSERT INTO `ritems`(`mdescription`, `umo`, `hsncode`, `urate`, `gst`, 
	...
	print "self.location='tguploaditems_list.php';";
	print "</script>";
...
$s_fee=$_POST['s_fee'];
$s_code=$_POST['s_code'];		
	$sq=mysqli_query($link,"update  `ritems` set `mdescription`='$mdesc', `umo`='$umo', `hsncode`='$hsn',

...
<div class="row">
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
									...
									<?php $idd=$r1['id'];?>
										<tr><td align="right" colspan="2">Qutation Print(Click Print Button to view Qutation Print)   <?php if($state=='KN'){ ?>
										...
										if(isset($_POST['update'])){
											...
											$sq=mysqli_query($link,"update add_knqot set req_amnt_settled='$amnt',status='Document Required' where quet_num='$qt_no'");
											
											
											$ssq=mysqli_query($link,"update knrequest_amnt set transfer='$transfer',transfer_date='$transfer_date',status='Amount Transferred',remarks1='$remarks1' where id='$id'");
			...
			print "</script>";
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="knreq_list1.php"><button class="btn btn-danger" type="button" name="button" id="Close">

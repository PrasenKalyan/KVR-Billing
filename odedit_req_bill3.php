                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="odqot_list.php"> Payment Pending List</a>
                            </li>
                            <li>
                                <a href="">Edit Payment Pending List</a>
                            </li>
  ...
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
										...
										if(isset($_POST['update'])){
											...
											$recevid_amnt=$_POST['recevid_amnt'];
												...
												$sq=mysqli_query($link,"insert into odpayment
												...
												$ssq=mysqli_query($link,"update  odqot_bill set status='Paid' where inv_num='$inv_no'	");
												
												$us=mysqli_query($link,"select quet_num from odqot_bill where inv_num='$inv_no'") or die(mysqli_error($link));
										$us1=mysqli_fetch_assoc($us);
										$qqno=$us1['quet_num'];
										mysqli_query($link,"update add_odqot  set status='Payment Received' where quet_num='$qqno'") or die(mysqli_error($link));
											
										
											
											print "<script>";
			print "alert('Invoice Sucessfully Updated');";
			print "self.location='odbill_list3.php';";
			print "</script>";
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="odbill_list3.php"><button class="btn btn-danger" type="button" name="button" id="Close">

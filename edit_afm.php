                            ...
                            <div class="col-xs-12">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title">AFM Details</h3>
								</div>
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action=""  autocomplete="off">
								   ...
								   <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> AFM Name </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="afm.php"><button class="btn btn-danger" type="button" name="button" id="Close">

...
<style>
	...
	$.ajax({          
        	type: "GET",
        	url: "getknftypedescriptionauto.php",
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="knbill_list2.php"> To be raised Invoice</a>
                            </li>
                            <li>
                                <a href="">To be raised Invoice</a>
                            </li>
...
// }
	...
	$iname5 = ($iname5);
	 ...
	 $iname5 = ($img3);
			...
			print "self.location='knbill_list2.php';";
			print "</script>";
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="knbill_list2.php"><button class="btn btn-danger" type="button" name="button" id="Close">

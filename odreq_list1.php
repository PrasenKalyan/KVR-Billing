...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_odqot.php'" id="bsearch">
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                  ...
                  <div class="col-sm-2"><b><a href="qut_odapvamt_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
				</div>
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
									...
									if(isset($_POST['bsearch'])){
											 ...
											 $y="select * from odrequest_amnt where  quet_num like '%$bsearch%' or ac_det like '%$bsearch%'  and confirm='Yes' and status!='Amount Transferred' group by ac_det order by id desc";
												} else {
										...
										$ada=0;
											while($rs1=mysqli_fetch_array($t)){
											    $tid=$rs1['id'];
							$qtno=$rs1['quet_num'];
						$a="select store_code,ro_no,ro_date,falt_desc,tot_base,tot_ser,tot_gst,adv_amnt,adv_amnt1,adv_amnt2,gst_type,net,bal from add_odqot where quet_num='$qtno'";
						...
						$k=mysqli_query($link,"select * from dpr where store_code='$str_code'");
							$r3=mysqli_fetch_array($k);
												...
												<tr>
												  ...
												  <td>
												      <?php
												     $adamt="select sum(approve_amnt) as req_amnt from odrequest_amnt where quet_num='$qtno'and  status='Amount Transferred' and   confirm='Yes'" ;
                                      ...
                                      <td class="hidden-480"><?php 
									 $ac=$rs1['ac_det'];
									 $a="select sum(approve_amnt) as req_amnt from odrequest_amnt where quet_num='$qtno'and id='$tid' and status!='Amount Transferred' and   confirm='Yes' and ac_det='$ac' ";
										  ...
										  $r2=mysqli_fetch_array($sr1);
											  ...
											  $req_amnt=$r2['req_amnt'];
                                                $apt=$apt+$req_amnt;
                                                       ...
                                                       <!-- <td class="hidden-480"><?php echo $rs1['user']; ?></td>-->
                                                        ...
                                                        <td class="hidden-480"><?php 
                                                         ...
                                                         $sq=mysqli_query($link,"select emp_name from emp where employeeid='$cempname' limit 1");
                                                          ...
                                                          <?php    if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='sumanthpotluri') or  ($tsname=='JFMOD22232823')){ ?>  
                                                          <a href="odreq_amnt_list1.php?id=<?php echo $rs1['id']  ?>" onclick="return confirm('are you sure?')">
													...
													?>
                                                    <tr><th align="center" colspan="10" style="text-align:right;color:red;">Total</th><td><?php echo $ro; ?></td><td><?php echo $sf; ?></td><td><?php echo $gsta; ?></td><td><?php echo $tamt; ?></td><td><?php echo $reqam; ?></td><td><?php echo $bala; ?></td><td></td><td></td><td><?php echo $ada?></td><td></td><td><?php echo $apt; ?></td><td colspan="4"></td></tr> 
										...
										<h2>Account Summary</h2>
                                            ...
                                            if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='odbilling') or ($tsname=='sumanthpotluri')   or ($tsname=='JFMOD22232823')){
											    	$y="select distinct ac_det from odrequest_amnt where confirm='Yes' and status!='Amount Transferred'  ";
											}else{
											    	$y="select distinct ac_det from odrequest_amnt where  user='$tsname'and   confirm='Yes' and status!='Amount Transferred'";
											}
										...
										$mut=0;
											...
											while($uy1=mysqli_fetch_array($uy)){
											    ...
											    $mu=mysqli_query($link,"select sum(approve_amnt) as amt from odrequest_amnt where ac_det='$acd' and status!='Amount Transferred' and confirm='Yes'");

...
$objPHPExcel->getActiveSheet()->mergeCells('A1:AH1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'OD PAYMENT RECEIVED LIST');
...
header('Content-Disposition: attachment;filename="odpaymentreceived.xlsx"'); //tell browser what's the file name

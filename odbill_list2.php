...
<div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
									...
									<!--<a href="addbill.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>-->
                                        ...
                                        <div class="col-sm-12"><a href="addodinvoice.php"><button class="btn btn-primary btn-xs">Add New Invoice </button></a></div>
                                        <div>
                ...
                <input type="text" class="form-control pull-right" id="myInput" name="search" placeholder="Search   " onkeyup="myFunction()">
                  ...
                  <div class="col-sm-2"><b><a href="qut_odraise_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
                                        ...
                                        $start_from = ($page-1) * $results_per_page;
                                            ...
                                            $df=$diff->format("%a");
                                                if($df > 7){
													...
													$ssq=mysqli_query($link,"select * from odrequest_amnt where quet_num='$q'");
...
<!--<td class="center">
													  ...
													  if($st=='OD'){
													  $ssq1=mysqli_query($link,"select * from add_odqot where quet_num='$q'");
													  } 
...
echo "<li><a href='odbill_list2.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

for($i=0;$i<$total_pages;$i++)
{
if(($i+1)==$page) 
echo "<li><a href='odbill_list2.php?page=".($i+1)."' class='button' style='color:red'>".($i+1)."</a></li>";
else
echo "<li><a href='odbill_list2.php?page=".($i+1)."' class='button'>".($i+1)."</a></li>";
}
echo "<li><a href='odbill_list2.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

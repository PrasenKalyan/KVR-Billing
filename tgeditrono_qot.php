                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="tgqot_list.php"> Quotations List</a>
                            </li>
                            <li>
						...
						<input type="hidden" name="serv_code[]" value="<?php echo $rs1['serv_cap']; ?>" style="width:50px;" class="" id="serv_code<?php echo $i?>" />	   
									...
									<td><input style="width:60px;" type="text" readonly placeholder="Total Serv" name="tot_serv" class="txt5" value="<?php echo $r['tot_ser'];?>" id="tot_serv" />+
                                        ...
                                        if(isset($_POST['update'])){
                                            $id1=$_POST['ids'];
                                            $rono=$_POST['ro_no'];
                                            $rodate=$_POST['ro_date'];
                                            $ponumber=$_POST['po_no'];
                                            $podate=$_POST['po_date'];
                                            $po_type=$_POST['po_type'];
                                           $res= mysqli_query($link,"update add_tgqot set ro_no='$rono',ro_date='$rodate',po_no='$ponumber',po_date='$podate',po_type='$po_type' where id='$id1'") or die(mysqli_error($link));

...
<div class="row">
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
									...
									<?php $idd=$r1['id'];?>
										<tr><td align="right" colspan="2">Qutation Print(Click Print Button to view Qutation Print)   <?php if($state=='AP' or $state=='TG' or $state=='KL' or $state=='TN' or $state=='KN' or $state=='OD'){ ?>
										<a onclick="window.open('qut_print.php?id=<?php echo $idd;?>&state=<?php echo $state; ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
										<img src="images/printer.png"></a>
										<?php } else { ?>
										<a onclick="window.open('qut_print1.php?id=<?php echo $idd;?>&state=<?php echo $state; ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
			...
			print "</script>";
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="req_list1.php?state=<?php echo $state; ?>"><button class="btn btn-danger" type="button" name="button" id="Close">

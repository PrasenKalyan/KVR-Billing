                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
										...
										<textarea name="note" required class="form-control"><?php echo $r1['note'];?></textarea></td>	
  ...
  <td align="left">
    <input type="text" name="tot_base" id="tot_base" class="form-control" readonly 
           value="<?php echo $tot_base; ?>">
			...
			print "self.location='bill_list2.php?state=$state';";
			print "</script>";
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="bill_list2.php?state=<?php echo $state; ?>"><button class="btn btn-danger" type="button" name="button" id="Close">

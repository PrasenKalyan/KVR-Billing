...
$objPHPExcel
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A1', 'JTECHNO  FACILITY MANAGEMENT PVT.LTD');
...
while($row	=	$result->fetch_assoc()){
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('Q'.$rowCount, mb_strtoupper($row['desc1'],'UTF-8'));

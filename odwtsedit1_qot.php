                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="odqot_list.php"> Quotations List</a>
                            </li>
                            <li>
...
<div class="row">
 ...
 <form name="frm" method="post" action="odwtsqot1_suc.php" enctype="multipart/form-data">
											...
											<?php   $id=count($_REQUEST['id']);
										     ...
										     $aa="select * from add_odqot1 where id1='$id1'";
												...
												while($rs1=mysqli_fetch_array($sq)){
													...
													<a onclick="return confirm('Are you sure you want to delete this item?');" href='oddelete_line.php?id=<?php echo $rs1['id']; ?>&id1=<?php echo $rs1['id1'];?>'><input type="button" class="btn btn-danger" value="Delete"></button>
							</a>
							<?php }?>
						...
						<input type="hidden" name="serv_code[]" value="<?php echo $rs1['serv_cap']; ?>" style="width:50px;" class="" id="serv_code<?php echo $i?>" />	   
									...
									<td><input style="width:60px;" type="text" readonly placeholder="Total Serv" name="tot_serv" class="txt5" value="<?php echo $r['tot_ser'];?>" id="tot_serv" />+
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="odwtsqot_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">

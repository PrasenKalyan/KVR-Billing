...
xmlhttp.open("GET","getfilterinforpages.php?q="+str+"&statetable=".$qottable,true);
xmlhttp.send();
}
                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#"><?php echo $state; ?> Quotations List</a>
                            </li>
...
echo "<li><a href='wtsqot_list.php?state=$state&page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='wtsqot_list.php?state=$state&page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

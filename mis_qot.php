...
?>
    ...
    <head>
        ...
        <title>AP Miscellaneous Details</title>
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li><i class="ace-icon fa fa-cog home-icon"></i><a href="mis_qot.php?page=1">AP Miscellaneous Details List</a></li>
                        </ul>
                    </div>

                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-header">AP Miscellaneous Details</div>

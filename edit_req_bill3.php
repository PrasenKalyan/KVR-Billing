                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="qot_list.php?state=<?php echo $state; ?>"><?php echo $state; ?> Paymnet Pending List</a>
                            </li>
                            <li>
                                <a href=""><?php echo $state; ?> Edit Paymnet Pending List</a>
                            </li>
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <h1 align="center">
                            <?php echo $state; ?> Edit Paymnet Pending List
  ...
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
										...
										if(isset($_POST['update'])){
											...
											$recevid_amnt=$_POST['recevid_amnt'];
												...
												$ssq=mysqli_query($link,"update  ".$qotbill." set status='Paid' where inv_num='$inv_no'	");
												
												$us=mysqli_query($link,"select quet_num from ".$qotbill." where inv_num='$inv_no'") or die(mysqli_error($link));
										$us1=mysqli_fetch_assoc($us);
										$qqno=$us1['quet_num'];
										mysqli_query($link,"update ".$qottable."  set status='Payment Received' where quet_num='$qqno'") or die(mysqli_error($link));
											
										
											
											print "<script>";
			print "alert('Invoice Sucessfully Updated');";
			print "self.location='bill_list3.php?state=$state';";
			print "</script>";
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="bill_list3.php?state=<?php echo $state; ?>"><button class="btn btn-danger" type="button" name="button" id="Close">

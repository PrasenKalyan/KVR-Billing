                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="odqot_list.php"> Document List</a>
                            </li>
                            <li>
                  ...
                  <?php  $qtno=$_GET['id'];
                  $k=mysqli_query($link,"select id from odrequest_amnt where quet_num='$qtno'") or die(mysqli_error($link));
while($k1=mysqli_fetch_array($k)){
$klarray[]=$k1['id'];
}

						$sq=mysqli_query($link,"select * from add_odqot where quet_num='$qtno'");
						...
						$y=mysqli_query($link,"select * from odrequest_amnt where quet_num='$qtno' order by id desc limit 1");
...
//$/t=mysqli_query($link,$aa) or die(mysqli_error($link));?>
                         ...
                         <div class="table-responsive">
										...
										/*	$id=$_POST['ids'];
											...
											$transfer='0.00';
											 ...
											 // $dd="update odrequest_amnt set confirm='$confirm',approve_amnt='$transfer',gstamt='0.00',req_amnt='0.00',req_date='0000-00-00',transfer='0.00',ac_det='',gsttype='',
											 // status='Cancel' where quet_num='$id'";
											 	$dd="delete from odrequest_amnt where quet_num='$id'";
											$ssq=mysqli_query($link,$dd) or die(mysqli_error($link));
											
											//exit;
											 $dd1="update add_odqot set adv_amnt='0.00',adv_amnt1='0.00',adv_amnt2='0.00',adv_date='0000-00-00',adv_date1='0000-00-00',adv_date2='0000-00-00',
			...
			print "self.location='odbill_list.php';";
			print "</script>";*/
...
$reason=$_POST['reason'];
		    ...
		    $v="update add_odqot set status='work to be started',
...
gst_amount2='0.00',gst_amount3='0.00',gst_amount4='0.00',reason='$reason',doctoworkrevertfile='$iname1'		
	...
	$sq=mysqli_query($link,$v) or die(mysqli_error($link));
											 ...
											 echo	$dd="delete from odrequest_amnt where quet_num='$qt_no'";
	...
	print "</script>";
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="odbill_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">

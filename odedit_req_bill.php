										...
										if(isset($_POST['update'])){
                                        	...
                                        	$iname1 = ($iname1);
                                        	 ...
                                        	 $iname1 = ($img1);
												...
												$sq=mysqli_query($link,"update  odrequest_amnt set bill_status='payment pending',req='$req',note='$note',docr_status='' where quet_num='$qt_no'");
												...
												bill_rec_date='$bill_date',invoice_no='$inv_no',invoice_date='$inv_date',inv_sub_date='$inv_sub_date',invoice_status='$st',status='To Be Raise Invoice' where quet_num='$qt_no'");
												 	...
												 	$sq=mysqli_query($link,"update  odrequest_amnt set bill_status='payment pending',req='$req',note='$note',docr_status='',not_file='$iname1' where quet_num='$qt_no'");

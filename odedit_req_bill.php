                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="odqot_list.php"> Document Required List</a>
                            </li>
                            <li>
...
<div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <?php $ssq=mysqli_query($link,"select * from odqot_bill where quet_num='$id'");
										...
										if(isset($_POST['update'])){
                                        	...
                                        	$iname3 = ($iname3);
                                        	 ...
                                        	 $iname3 = ($img3);
												...
												$sq=mysqli_query($link,"update  odrequest_amnt set bill_status='payment pending',req='$req', not_file='$iname1',not_file1='$iname2',not_file2='$iname3',note='$note',docr_status='' where quet_num='$qt_no'");
												
							                    $k2=mysqli_query($link,"select * from odqot_bill where quet_num='$qt_no'") or die(mysqli_error($link));
									            if(mysqli_num_rows($k2)==0)
									            {
												$sq=mysqli_query($link,"insert into odqot_bill (quet_num,bill_date,inv_num,inv_date,note,inv_sub_date,status,state,user)
												...
												bill_rec_date='$bill_date',invoice_no='$inv_no',invoice_date='$inv_date',inv_sub_date='$inv_sub_date',invoice_status='$st',status='To Be Raise Invoice' where quet_num='$qt_no'");
												 	...
												 	$sq=mysqli_query($link,"update  odrequest_amnt set bill_status='payment pending',req='$req',note='$note',docr_status='',not_file='$iname1',not_file1='$iname2',not_file2='$iname3' where quet_num='$qt_no'");

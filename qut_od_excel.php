...
$objPHPExcel->getActiveSheet()->mergeCells('A1:O1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'ODISHA QUOTATION LIST');
...
$objPHPExcel->getActiveSheet()->getStyle("A6:O6")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)
        ->getStartColor()->setRGB('0000FF');
...
header('Content-Disposition: attachment;filename="odquotationslist.xlsx"'); //tell browser what's the file name

                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="date_excel.php">Employee Activity Tracker</a>
                            </li>
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <h1 align="center">
                          Employee Activity Report Excel Sheet
                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title"> Employee Activity Report Excel</h3>
								</div>
                               
                                <form class="form-horizontal" method="post" id="validation-form" role="form" method="post" action="excel_date.php"  autocomplete="off" target="_blank">

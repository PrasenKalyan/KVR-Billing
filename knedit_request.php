                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">KN Request Amount Approve  </a>
                            </li> -->
                            <li>
                                <a href="knqot_list.php"> KN Request Amount Approve </a>
                            </li>
                            <li>
  ...
  <input type="hidden" name="ses" value="<?php echo $name;?>">
                                        ...
                                        <td align="right">Request User</td><td><input type="text" value="<?php echo $r['user'];?>"   name="inv_date" id="inv_date" class="form-control"></td>
                                           ...
                                           <?php 
										    ...
										    $a="select sum(approve_amnt) as amt from knrequest_amnt where quet_num='$qot'";
										   $qwe=mysqli_query($link,$a);
										   $re=mysqli_fetch_array($qwe);
										    $amt=$re['amt'];
											
											 $a="select sum(transfer) as amt1 from knrequest_amnt where quet_num='$qot'";
										   $qwe=mysqli_query($link,$a);
                                       ...
                                       <td align="right">Total Request Amount</td><td align="left">
										...
										<?php $idd=$r1['id'];?>
										<tr><td align="right" colspan="2">Quotation Print(Click Print Button to view Quotation Print)   <?php if($state=='KN'){ ?>
										<a onclick="window.open('knqut_print.php?id=<?php echo $idd;?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
										<img src="images/printer.png"></a>
										<?php } else { ?>
										<a onclick="window.open('knqut_print1.php?id=<?php echo $idd;?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
                                       ...
                                       <td align="right">Image 1</td><td><img src="upload/<?php echo $r1['img1'];?>" onclick="window.open('knqut_image.php?id=<?php echo $r1['img1'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
										...
										<img src="upload/<?php echo $r1['img2'];?>" onclick="window.open('knqut_image.php?id=<?php echo $r1['img2'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                      
										</td>	
                                        <td align="right">Image 3</td><td><img src="upload/<?php echo $r1['img3'];?>" onclick="window.open('knqut_image.php?id=<?php echo $r1['img3'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                      </td>
                                        </tr>
										...
										<button class="btn btn-info" type="submit" name="update<?php echo $i; ?>" id="submit">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="knreq_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">
							...
							echo $dd="update knrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt1',remarks='$remarks' where id='$id'";
							$ssq=mysqli_query($link,$dd);
							
								mysqli_query($link,"update add_knqot set status='Approved Amount' where quet_num='$qt_no'") or die(mysqli_error($link));
							print "<script>";
			print "alert('Amount Approved Successfully');";
			print "self.location='knreq_list.php';";
			print "</script>";
										}}?>
							<?php		
	if(isset($_POST['update2'])){
							...
							echo $dd="update knrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt2',remarks='$remarks' where id='$id2'";
							$ssq=mysqli_query($link,$dd);
			...
			print "</script>";
							...
							echo $dd="update knrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt3',remarks='$remarks' where id='$id3'";
							$ssq=mysqli_query($link,$dd);

...
if(isset($_POST['submit'])){
	...
	$tr=mysqli_fetch_array($t);
	 $empemail=$tr['emp_email'];
	  echo $a="INSERT INTO `add_qot`(`store_code`, `inv_date`, `quet_num`, `tot_base`, `tot_ser`, `tot_gst`, `net`,  `ses`,falt_no,falt_date,falt_desc,status,`wd`)
	...
	$sq=mysqli_query($link,$a);
	 ...
	 if ($wd === 'approve') {
		...
		header("Location: wtsqot_list.php");
		exit();
	}
...
if($mark=="yes"){
    ...
    $sq=mysqli_query($link,"update add_qot set status='Not Required',markfile='$iname1',wd='$wd' where id='$id' ") or die(mysqli_error($link));

...
<div class="row">
                ...
                <input type="text" class="form-control pull-right" id="myInput" name="search" placeholder="Search By Quotation Name No  " onkeyup="myFunction()">
                  ...
                  <div class="col-sm-2"><b><a href="qut_klpr_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                   ...
                                   <div style="overflow-x:auto;">     
											...
											while($rs1=mysqli_fetch_array($t)){
													...
													$q=$rs1['inv_no'];
													$st=$rs1['state'];
													$yu=mysqli_query($link,"select inv_date,inv_sub_date,speriod,ftype,sum(gst28) as gst28,sum(gst18) as gst18,sum(gst12) as gst12,sum(gst5) as gst5,sum(gst5) as gst5,sum(tbase) as tbase from klqot_bill where inv_num='$q'") or die(mysqli_error($link));
                                                    ...
                                                    <tr>
                                                     ...
                                                     <td class="hidden-480">
                                                        ...
                                                        <?php echo $rs1['user'];?>
														 ...
														 <td class="hidden-480">
                                                        <a href="kledit_paymentrecv.php?id=<?php echo $rs1['id'];?>"><img src="images/edit.gif"/></a>
                                                        </td>	
                                                        ...
                                                        <td>
														    ...
														    $tp=mysqli_query($link,"select file from klqot_bill where inv_num='$q'") or die(mysqli_error($link));
														    ...
														    <?php }?>
														      ...
														      <td><a href="kldelete_recv.php?id=<?php echo $rs1['id']; ?>"><img src="images/Icon_Delete.png"/></a></td>
												</tr>
											<?php $i++; } ?>
...
echo "<li><a href='klbill_list4.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='klbill_list4.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

...
<div class="row">
             ...
             <div class="col-sm-2"><b><a href="knexp_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
            	</div>
                                            ...
                                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												if(($tsname=="admin") or ($tsname=="durgarao") or ($tsname=="sumanthpotluri")or ($tsname=="accounts")){ 
												    $p="select * from expenses where state='KN'";
												}elseif($tsname=="accounts"){
												    $p="select * from expenses where state='KN' and status='Approved'";
												}else{
                                                        $p="select * from expenses where state='KN' and user='$tsname'";
												}
												$k=mysqli_query($link,$p) or die(mysqli_close($link));
												$i=1;
											...
											<tr>
											    <td><?php echo $i; ?></td>
                                                 ...
                                                 <td><?php echo $k1['payment_type']; ?></td>

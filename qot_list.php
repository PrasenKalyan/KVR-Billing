...
$r1=mysqli_fetch_array($ssq1);
                                                   ...
                                                   <a onclick="window.open('qut_print.php?id=<?php echo $rs1['id'];?>&state=AP','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"
												   class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
                                                        </td> 
                                                        
                                                         <td class="hidden-480"><a href="qut_excel.php?id=<?php echo $rs1['id']; ?>&state=AP">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                        
                                                        <td class="hidden-480"><a href="qut_excel_bill.php?id=<?php echo $rs1['id']; ?>&state=AP">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                     <td class="hidden-480"><a href="qut_excel_mis.php?id=<?php echo $rs1['id']; ?>&state=AP">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                       
                                                        
                                                        <td class="hidden-480">
                                                       <a href="qot_pdf.php?id=<?php echo $rs1['id'];?>&state=AP"
...
echo "<li><a href='qot_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

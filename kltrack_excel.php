...
$objPHPExcel->getActiveSheet()->mergeCells('A1:BJ1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A1', 'KVR BEST PROPERTY MANAGEMENT');
...
while($row	=	$result->fetch_assoc()){
	...
	$ds10="select sum(approve_amnt) as apamount,sum(transfer) as kltft,sum(gstamt) as tngst from klrequest_amnt where quet_num='$qno'";
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('AK'.$rowCount, mb_strtoupper('KL','UTF-8'));

...
<?php $sqy=mysqli_query($link,"select * from organization where id='1'");
			...
			$vendor_name4=$r2y['vendor_name4'];
			$kn_address=$r2y['kn_address'];
			$kn_gst=$r2y['kn_gst'];
			$vendor_code4=$r2y['vendor_code4'];
			?>
...
<div style="border:1px solid #000;">
 <table >
		...
		<?php echo $r1['address'];?><br/>
				<?php echo  $st=$r1['state']; if($st=='KN'){ echo "KARNATAKA"; } ?><br/>
			<?php echo $r1['gst_in'];?>
			</b>
...
<tr>
	<th  colspan="14" style="text-align:right;padding-right:10px;font-size:20px;">For JYOTHI FACILITY MANAGEMENT Pvt. Ltd.<br/><img src="sign.jpeg" height="70"/><br/>Authorised Signatory
</th>
</tr>
      </tbody>
    </table></td></tr></table>
...
echo  "<script type=\"text/javascript\"> 
   ...
   setTimeout(\"DoTheRedirect('knqot_list.php')\",parseInt(2*1000));

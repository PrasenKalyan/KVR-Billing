...
<div class="row">
             ...
             <div class="col-sm-2"><b><a href="klexp_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
            	</div>
...
echo "<li><a href='klexpenseslist.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='klexpenseslist.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_qot.php'" id="bsearch">
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                  ...
                  <div class="col-sm-2"><b><a href="qut_apreqamt_excel.php?state=<?php echo $state;?>&user=<?php echo $tsname;?>" class="btn btn-primary btn-xs">XL Download</a></b>
...
?>
												 ...
												 <td class="hidden-480"><?php echo $r1['tot_gst']; ?></td>
												  ...
												  ?></td>
                                                       ...
                                                       <td class="hidden-480"><a href="req_amnt_list.php?id=<?php echo $rs1['id']; ?>&amt=<?php echo $amt;?>&state=<?php echo $state;?>" onclick="return confirm('are you sure?')">
                                                        <img src="update.png" width="16" height="16"></a></td>
                                                    <td class="hidden-480"><a href="edit_request.php?id=<?php echo $rs1['id']; ?>&state=<?php echo $state;?>">
                                                        <img src="images/edit.gif"></a>
                                                     
                                                     <a href="cancel_request.php?id=<?php echo $rs1['id']; ?>&state=<?php echo $state;?>">
                                        ...
                                        echo $uy1['ac_det']."-".$at."<br/>";
                                                       ...
                                                       <td class="hidden-480">
                                                         <?php if(($tsname=='admin') or ($tsname=='durgarao')or ($tsname=='sumanthpotluri')){ ?>
                                                           ...
                                                           <a href="req_amnt_list.php?id=<?php echo $qot; ?>&amt=<?php echo $amt;?>&state=<?php echo $state;?>" onclick="return confirm('are you sure?')">

...
<div class="row">
                ...
                <input type="text" class="form-control pull-right" id="myInput" name="search" placeholder="Search By Quotation No or Invoice No " onkeyup="myFunction()">
                  ...
                  <div class="col-sm-2"><b><a href="qut_aprsi_excel.php?user=<?php echo $tsname ?>&state=<?php echo $state;?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
                                        ...
                                        $start_from = ($page-1) * $results_per_page;
											...
											while($rs1=mysqli_fetch_array($t)){
                                                   ...
                                                   <td>
													...
													<td class="hidden-480"><a href="qotti_pdf.php?id=<?php echo $rs1['quet_num']; ?>&state=<?php echo $state; ?>">

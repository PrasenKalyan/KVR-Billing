						...
						<tr><td align="right">Remarks</td><td align="left">
										...
										if(isset($_POST['update'])){
											...
											$remarks=$_POST['remarks'];
												...
												$sq=mysqli_query($link,"insert into tgpayment
												...
												$ssq=mysqli_query($link,"update  tgqot_bill set status='Paid' where inv_num='$inv_no'	");
												
												$us=mysqli_query($link,"select quet_num from tgqot_bill where inv_num='$inv_no'") or die(mysqli_error($link));
										$us1=mysqli_fetch_assoc($us);
										$qqno=$us1['quet_num'];
										mysqli_query($link,"update add_tgqot  set status='Payment Received' where quet_num='$qqno'") or die(mysqli_error($link));

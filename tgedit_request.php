...
<div class="row">
 ...
 <input type="hidden" name="ids<?php echo $i; ?>" value="<?php echo $id1?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
							...
							echo $dd="update tgrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt1',remarks='$remarks' where id='$id'";
	...
	if(isset($_POST['update2'])){
							...
							echo $dd="update tgrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt2',remarks='$remarks' where id='$id2'";
							$ssq=mysqli_query($link,$dd);
							mysqli_query($link,"update add_tgqot set status='Approved Amount' where quet_num='$qt_no'") or die(mysqli_error($link));
							print "<script>";
			print "alert('Amount Approved Successfully');";
			...
			print "</script>";
							...
							echo $dd="update tgrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt3',remarks='$remarks' where id='$id3'";
							$ssq=mysqli_query($link,$dd);

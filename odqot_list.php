...
<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_odqot.php'" id="bsearch">   Add New  </button>
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
				  ...
				  <div class="col-sm-2"><b><a href="qut_od_excel.php" class="btn btn-primary btn-xs">XL Download</a></b></div>
											...
											// $y="select a.store_name,a.city,b.quet_num,b.store_code,b.inv_date,b.id
											 ...
											 $y="select * from add_odqot where quet_num like '%$bsearch%' or falt_no like '%$bsearch%'  or status like '%$bsearch%'order by id desc";
												...
												/*echo $y="select  a.quet_num,a.store_code,a.inv_date,a.status,a.id from add_odqot a,dpr b where a.quet_num='$qot_nun'
												 ...
												 $y="select  a.quet_num,a.store_code,a.inv_date,a.status,a.id,a.ses from add_odqot a,dpr b where
...
$r1=mysqli_fetch_array($ssq1);
                                                        ...
                                                        $qc=mysqli_query($link,"select status from qot_bill where quet_num='$quetnumc'");
                                          ...
                                          <?php }
                                                ...
                                                ?>        
                                                   ...
                                                   <a onclick="window.open('qut_print.php?id=<?php echo $rs1['id'];?>&state=OD','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"
												   class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
                                                        ...
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                     <td class="hidden-480"><a href="odqut_excel_mis.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                       
                                                        
                                                        <td class="hidden-480">
                                                       <a href="qot_pdf.php?id=<?php echo $rs1['id'];?>&state=OD"
...
echo "<li><a href='odqot_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='odqot_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

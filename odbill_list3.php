...
<div class="row">
                ...
                <input type="text" class="form-control pull-right" id="myInput" name="search" placeholder="Search By Quotation Name No or Invoice no " onkeyup="myFunction()">
                  ...
                  <div class="col-sm-2"><b><a href="qut_odpp_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                   ...
                                   <div style="overflow-x:auto;">     
                                        ...
                                        $start_from = ($page-1) * $results_per_page;
											...
											$ssq1="select * from odqot_bill where status='Un Paid' and (quet_num like  '%$bsearch%' or inv_num like '%$bsearch%') ";
													  } else {
													    //    if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='odbilling')or ($tsname=='sumanthpotluri')){
													           $ssq1="select * from odqot_bill where status='Un Paid' order by id desc  LIMIT $start_from,$results_per_page ";
													    //   }else{
													    //        $ssq1="select * from odqot_bill where status='Un Paid' and user='$tsname' order by id desc  LIMIT $start_from,$results_per_page ";
													    //   }
                                                   ...
                                                   <td>
                                                       ...
                                                       ?>
                                                        ...
                                                        <td class="hidden-480">
                                                            ...
                                                            <a href="odedit_req_bill3.php?id=<?php echo $q; ?>&id1=<?php echo $tbase;?>&q=<?php echo $q?>">
                                                        <img src="images/edit.gif"></a>														
                                                       	...
                                                       	<td>
														    ...
														    $tp=mysqli_query($link,"select file from odqot_bill where id='$tgid'") or die(mysqli_error($link));
														    ...
														    <td>
														         <a href="odupload_req_bill.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a>
...
echo "<li><a href='odbill_list3.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='odbill_list3.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

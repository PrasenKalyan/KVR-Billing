...
<table border='1' style="width:90%" align="center"  cellpadding="0" cellspacing='0'>
        <thead>
			...
			<img src="images/excel_logo.png" height="100"/></th></tr>
        </thead>
        <tfoot>
...
<?php $sqy=mysqli_query($link,"select * from organization where id='1'");
			...
			$vendor_name4=$r2y['vendor_name'];
			$kn_address=$r2y['od_address'];
			$kn_gst=$r2y['od_gst'];
			$vendor_code4=$r2y['vendor_code'];
			?>
 ...
 <table >
		...
		Vendor Code :<br />
			...
			<td>
			<b> <?php echo $vendor_name4;?><br/>
			<?php echo $kn_address;?><br/>
			<?php echo $r1['state'];?> STATE<br/>
			<?php echo $kn_gst ?><br/>
			<?php echo $r1['state_code'];?><br/>
			<?php echo $vendor_code4;?></b>
			</td>
			</tr>
...
<div style="border:1px solid #000;">
 <table >
		...
		<?php echo $r1['address'];?><br/>
				<?php echo  $st=$r1['state']; if($st=='OD'){ echo "Odisha"; } ?><br/>
			<?php echo $r1['gst_in'];?>
			</b>
...
<th style="width:60px;" colspan="1">REMARKS</th>
...
while($t1=mysqli_fetch_array($t)){
	...
	<th style="width:60px;" colspan="1"><?php echo $t1['model']; ?></th>
		...
		<th style="width:60px;" colspan="1"><?php if ($t1['serv_amt'] != '' and $t1['serv_amt'] != 0 ) {echo 'NON RC';} else {echo 'RC';} ?></th>
...
$i++; }
 ...
 <tr>
	<th  colspan="14"> SGST/UGST Amt (In Rs)</th>
	<th style="width:100px;"><?php echo $tx1/2;?></th>
	</tr>
<tr>
	<th  colspan="14"> CGST Amt (In Rs)</th>
	<th style="width:100px;"><?php echo $tx1/2;?></th>
	</tr>
 <tr>
	<th  colspan="14"> IGST Amt (In Rs)</th>
	<th style="width:100px;">0</th>
	</tr>
	<tr>
	<th  colspan="14"> Total GST  (In Rs)</th>
	
	<th style="width:100px;"><?php echo $tx1;?></th>
	</tr>
		<tr>
	<th  colspan="14"> Total Amount (In Rs)</th>
...
<tr>
	<th  colspan="14" style="text-align:right;padding-right:10px;font-size:20px;">For KVR BEST PROPERTY MANAGEMENT Pvt. Ltd.<br/><img src="sign.jpeg" height="70"/><br/>Authorised Signatory
</th>
</tr>
      </tbody>
    </table></td></tr></table>
...
echo  "<script type=\"text/javascript\"> 
   ...
   setTimeout(\"DoTheRedirect('odqot_list.php')\",parseInt(2*1000));

                        ...
                        <div class="row">
                            <div class="col-xs-6">
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="attdance1.php"  autocomplete="off" target="_blank">
...
<?php $sq=mysqli_query($link,"select distinct empid from 	request ");
while($r=mysqli_fetch_array($sq)){?>
<option value="<?php echo $r['empid']?>"><?php echo $r['empid'];?></option>
<?php }?>
</select>
												<strong> </strong>
                                        </div>

...
<div class="row">
             ...
             <div class="col-sm-2"><b><a href="odqut_gst_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
            	</div>
											...
											if(isset($_POST['bsearch'])){
											    ...
											    $y="select * from odrequest_amnt where gsttype='With GST'";
							                	    ...
							                	    if(($name=='admin') or ($name=='durgarao') or ($name=='accounts')  or ($tsname=='JFMOD22232823') ){
												 $y="select * from odrequest_amnt where gsttype='With GST'    ";
							                	    }else{
											...
											while($rs1=mysqli_fetch_array($t)){
												$q=$rs1['quet_num'];
												//$ramtn
												$r=mysqli_query($link,"select * from add_odqot where quet_num='$q'") or die(mysqli_error($link));
...
$currentDateTime = date('Y-m-d');
                                                if(($currentDateTime>$nextmonthdate)){
                                                   ...
                                                   <td class="hidden-480"><?php echo $rs1['ac_det'] ?></td>
                                                        ...
                                                        <td class="hidden-480">
                                                           <?php  if(($name=='admin') or ($name=='durgarao') or ($name=='accounts')  or ($tsname=='JFMOD22232823')){ ?>
                                                            <a href="odfile_edit.php?id=<?php echo $rs1['id']; ?>">
                                                     ...
                                                     <?php   }
														...
														<td class="hidden-480">
														   <?php   if(($name=='admin') or ($name=='durgarao') or ($name=='accounts') ){ ?>
														    <a href="odfile_view.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a>
											...
											//$ssq=mysqli_query($link,"select * from add_odqot where status='Not Required' quet_num='$bsearch'");
											
											
											//} else {
													 $y="select * from add_odqot2 where gst_type='With GST'    ";
											//}
											//$t=mysqli_query($link,$y) or die(mysqli_error($link));
											//$j=$k+1;
											//while($rs1=mysqli_fetch_array($t)){
...
echo "<li><a href='odwork2.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='odwork2.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

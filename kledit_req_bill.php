										...
										//}
                                        	...
                                        	$iname3 = ($iname3);
                                        	 ...
                                        	 $iname3 = ($img3);
												...
												$sq=mysqli_query($link,"update  klrequest_amnt set bill_status='payment pending',req='$req', not_file='$iname1', not_file1='$iname2',not_file2='$iname3',note='$note',docr_status='' where quet_num='$qt_no'");
												
												$k2=mysqli_query($link,"select * from klqot_bill where quet_num='$qt_no'") or die(mysqli_error($link));
												...
												bill_rec_date='$bill_date',invoice_no='$inv_no',invoice_date='$inv_date',inv_sub_date='$inv_sub_date',invoice_status='$st',status='To Be Raise Invoice' where quet_num='$qt_no'");
														...
														$sq=mysqli_query($link,"update  klrequest_amnt set bill_status='payment pending',req='$req',note='$note',docr_status='',not_file='$iname1', not_file1='$iname2',not_file2='$iname3', where quet_num='$qt_no'");
												//$sq=mysqli_query($link,"insert into klqot_bill (quet_num,bill_date,inv_num,inv_date,note,inv_sub_date,status,state,user)
											//	values('$qt_no','$bill_date','$inv_no','$inv_date','$note','$inv_sub_date','payment pending','$state','$name')");

                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="knbill_list3.php"> Payment Pending List</a>
                            </li>
                            <li>
  ...
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
										...
										if(isset($_POST['update'])){
											...
											$remarks=$_POST['remarks'];
												...
												$sq=mysqli_query($link,"insert into knpayment
												...
												$ssq=mysqli_query($link,"update  knqot_bill set status='Paid' where inv_num='$inv_no'") or die(mysqli_error($link));
												
												$us=mysqli_query($link,"select quet_num from knqot_bill where inv_num='$inv_no'") or die(mysqli_error($link));
										$us1=mysqli_fetch_assoc($us);
										$qqno=$us1['quet_num'];
										mysqli_query($link,"update add_knqot  set status='Payment Received' where quet_num='$qqno'") or die(mysqli_error($link));
											
										
											
											print "<script>";
			print "alert('Invoice Sucessfully Updated');";
			print "self.location='knbill_list3.php';";
			print "</script>";
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="knbill_list3.php"><button class="btn btn-danger" type="button" name="button" id="Close">

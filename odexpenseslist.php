...
<div class="row">
             ...
             <div class="col-sm-2"><b><a href="odexp_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
            	</div>
                                            ...
                                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
												<?php
												if(($tsname=="admin") or ($tsname=="durgarao") or ($tsname=="sumanthpotluri") or ($tsname=="accounts")){ 
												    $p="select * from expenses where state='OD'";
												}elseif($tsname=="accounts"){
												    $p="select * from expenses where state='OD' and status='Approved'";
												}else{
                                                        $p="select * from expenses where state='OD' and user='$tsname'";
												}
...
echo "<li><a href='odexpenseslist.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='odexpenseslist.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

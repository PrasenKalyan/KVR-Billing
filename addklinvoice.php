                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="klbill_list2.php"> To be raised Invoice</a>
                            </li>
                            <!-- <li>
                                <a href="">To be raised Invoice</a>
                            </li> -->
  ...
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
	...
	$iname5 = ($iname5);
	 ...
	 $iname5 = ($img3);
												...
												$sq1="insert into klqot_bill(bill_date,inv_num,inv_date,note1,inv_sub_date,status,speriod,ftype,tbase,gst28,gst18,gst12,gst5,gst0,user,file)

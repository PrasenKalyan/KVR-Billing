...
if($bsearch!=''){
											 ...
											 $sql="SELECT count(1) as total FROM tgqot_bill where status='payment pending'  and quet_num like  '%$bsearch%'  ";
											} else {
													if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='rasheed') or ($tsname=='accounts') or ($tsname=='apbilling') or  ($tsname=='Srujith.Nimmagadda') or ($tsname=='sumanthpotluri')or ($tsname=='naiduys') ){
											         $sql="SELECT count(1) as total FROM tgqot_bill where status='payment pending'    ";
											    }else{
											         $sql="SELECT count(1) as total FROM tgqot_bill where status='payment pending' and user='$tsadmin'  ";
											    }
...
{
if(($i+1)==$page) 
echo "<li><a href='tgbill_list2.php?page=".($i+1)."' class='button' style='color:red'>".($i+1)."</a></li>";
else
echo "<li><a href='tgbill_list2.php?page=".($i+1)."' class='button'>".($i+1)."</a></li>";
}
